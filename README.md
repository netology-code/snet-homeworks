...
5.1[x] [Переменные и условные операторы](5-01.md)

5.2[x] [Циклы и функции](5-02.md)

5.3[x] [Regexp и его использование для синтаксического анализа](5-03.md)

5.4[x] [Работа с текстовыми утилитами](5-04.md)

5.5[x] [Разбор скриптов и и их написание](5-05.md)
